          ...
          <div className="flex justify-between w-full flex-wrap">
            <div className="onboardLeft ">
              ...
              <div className="onboardRightContent customerInfo">
                <div
                  ...
                  className={
                    toggleState2 === "1" ? " active clientList" : " clientList "
                  }
                >
                  <p>
                    <div className="styled-input-container styled-input--square">
                      <div className="styled-input-single">
                        <input type="checkbox" name="fieldset-2" id="tequila" />
                ...
                <div
                  ...
                  className={
                    toggleState2 === "2" ? " active clientList" : " clientList "
                  }
                >
                  <p>
                    <div className="styled-input-container styled-input--square">
                ...
                <div
                  ...
                  className={
                    toggleState2 === "3" ? " active clientList" : " clientList "
                  }
                >
                  <p>
                    <div className="styled-input-container styled-input--square">
                ...
                <div
                  ...
                  className={
                    toggleState2 === "4" ? " active clientList" : " clientList "
                  }
                >
                  <p>
                    <div className="styled-input-container styled-input--square">
                ...
                <div
                  ...
                  className={
                    toggleState2 === "5" ? " active clientList" : " clientList "
                  }
                >
                  <p>
                    <div className="styled-input-container styled-input--square">
                ...
                <div
                  ...
                  className={
                    toggleState2 === "6" ? " active clientList" : " clientList "
                  }
                >
                  <p>
                    <div className="styled-input-container styled-input--square">
            ...
            <div className="onboardRight ">
              ...
              <div className="contactDetails">
                <div
                  className={
                    toggleState2 === "1" ? "tabContent active " : "tabContent"
                  }
                >
                  <div className="myCustomertag">
                    <p className="font-bold">
                      ...
                      <span className="font-normal">
                        43-20st Grand street, Brooklyn , NY 10042
                      </span>
                    </p>
                  </div>
                  <div className="px-3">
                    ...
                    <div className="w-full mb-4 ">
                      ...
                      <div className="w-full">
                        <input
                          type="text"
                          className="form_control"
                          placeholder="Elizaberth Walker"
                        />
                      </div>
                    </div>
                    <div className="w-full mb-4 ">
                      <h3>Contact Role</h3>
                      <div className="w-full">{/* <SelectBtn2 /> */}</div>
                    </div>
                    <div className="w-full mb-4 ">
                      <h3>Contact Email</h3>
                      <div className="w-full">
                        <input
                          type="text"
                          className="form_control"
                          placeholder="Elizabeth@lanovabistro.com"
                        />
                      </div>
                    </div>
                    <div className="w-full mb-4 ">
                    ...
                    <div className="w-full mb-16 ">
                      ...
                      <div className="w-full flex justify-center">
                        <div className="w-20">
                          <TimePicker.RangePicker activeBorderColor="#000" />{" "}
                          Mon
                        </div>
                      </div>
                    </div>
                    <div className="w-full mb-3 ">
                      <h3>
                        <input type="checkbox" className="accent-black" /> Share
                        my contact with this information
                      </h3>
                    </div>
                    <div className="w-full mb-2 ">
                      ...
                      <div className="w-full">
                        <textarea
                          className="form_control"
                          placeholder="Enter notes about your customer"
                        />
                      </div>
                    </div>
                    <div className="w-full mb-2 ">
                ...
                <div
                  className={
                    toggleState2 === "2" ? "tabContent active " : "tabContent"
                  }
                >
                ...
                <div
                  className={
                    toggleState2 === "3" ? "tabContent active " : "tabContent"
                  }
                >
                ...
                <div
                  className={
                    toggleState2 === "4" ? "tabContent active " : "tabContent"
                  }
                >
                ...
                <div
                  className={
                    toggleState2 === "5" ? "tabContent active " : "tabContent"
                  }
                >
                ...
                <div
                  className={
                    toggleState2 === "6" ? "tabContent active " : "tabContent"
                  }
                >
