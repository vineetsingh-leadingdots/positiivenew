...
const ForgotPassword = () => {
    ...
    return (
        ...
        <Row style={{ textAlign: 'center' }}>
         ...
         <Col span={24}>
         <Title level={4} style={{ textAlign: 'center' }}>Forgot your password?</Title>
         </Col>      
        </Row>
        <form
          className="text-left"
        ...
        >       
          <InputFields rowClass="form-group relative " placeholder="Email Address" inputClass="formControl pl-0" onChange={(e) => handlerChange(e)} />
