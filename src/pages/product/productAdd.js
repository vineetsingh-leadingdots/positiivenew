                ...
                <div className='card p-6 '>
                    <div className="formArea ">
                                    ...
                                    <div className="productImgage relative pt-5">
                                        <div className="file-upload">
                                            <input
                                                type="file"
                                                name="image"
                                                className="form_control" onChange={handleUpload}
                                            />
                                ...
                                <Row gutter={24}>
                                    ...
                                    <Col xs={24} md={12}>
                                        <div className="formgroup mb-4 ">
                                            ...
                                            <input id="name" name="name" type="text" className="form_control" />
                                        </div>
                                    </Col>
                                    <Col xs={24} md={12}>
                                        <div className="formgroup mb-4 ">
                                    ...
                                    <Col xs={24}>
                                        <div className="formgroup mb-4 poductImageDiv">
                                            ...
                                            <span className='text-[11px] text-[#474747]'>( Max Upload 2MB only PNG, JPG, TIFF, GIF, PFD Images allowed )</span>
                        ...
                        <Row gutter={20}>
                            <Col xs={24} md={12}>
                                <div className="formgroup mb-4 ">
                                    <label className="formBlock	">Enter key words to describe the taste</label>
                                    <select className="form_control">
                            ...
                            <Col xs={24} md={12}>
                                <div className="formgroup mb-4 ">
                                    <label className="formBlock	">Enter key words to describe which foods pair well</label>
                                    <input id="name" name="name" type="text" className="form_control" />
                                </div>
                            </Col>
                            <Col xs={24} md={12}>
                                <div className="formgroup mb-4 ">
                                    <label className="formBlock	">Write a brief description of the taste</label>
                                    <textarea className="form_control h-28" id="palate" name="palate" />
                                </div>
                            </Col>
                            <Col xs={24} md={12}>
                                <div className="formgroup mb-4 ">
                                    <label className="formBlock	">Write a brief description of food pairings</label>
                                    <textarea className="form_control h-28" id="palate" name="palate" />
                                </div>
                            </Col>
                            <Col xs={24} md={12}>
                                <div className="formgroup mb-3">
                                    <label className="formBlock	">Enter key words to describe the aroma</label>
                                    <input id="name" name="name" type="text" className="form_control" />
                                </div>
                            ...
                            <Col xs={24} md={12}>
                                <div className="formgroup mb-1 ">
                                    <label className="formBlock	">Write a brief description of food pairings</label>
                                    <textarea className="form_control h-48" id="palate" name="palate" />
                                </div>
                            </Col>
                            <Col xs={24} md={12}>
