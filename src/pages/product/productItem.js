            ...
            <div className='flex w-full justify-between flex-col items-center mb-6'>
                <div className='w-full'>
                    <div className="formgroup mb-4 ">
                        ...
                        <textarea className="form_control h-16"
                            id="appearance"
                            name="appearance"
                        ...
                        <Col xs={12} md={6}>
                            <div className=' w-1/4 text-center mb-6'>
                                <div className='relative mx-auto w-8'>
                                    ...
                                    <span className='folderClose'><CloseIcon /></span>
                                </div>
                    ...
                    <div className="w-full   ">
                        ...
                        <p className='flex items-center gap-1'>Set expiration date
                                <input type='checkbox'  className='w-4 h-4' onClick={() => setModal1Open(true)}/>
