                        ...
                        <Col md={12} >
                            <div className="contactList">
                                ...
                                <div className="w-full">
                                    <div className="mb-2">
                                        <p>General Manager</p>
                                        <p>Nina Athanosopolas
                                            917-239-7482 <span>Nina@Beveragedynamics.com </span>
                                        </p>
                                    </div>
                                    <div className="mb-2">
                                        <p>Brand Ambassador </p>
                                        <p>Phil Granger
                                            212-632-9482 <span>PhilG@Beveragedynamics.com </span>
                                        </p>
                                    </div>
                                    <div className="mb-2">
                                        <p>Regional Vice President </p>
                                        <p>Henry Evans
                                            917-239-7482 <span>Henry@Beveragedynamics.com </span>
                                        </p>
                                    </div>
                                    <div className="mb-2">
                                        <p>National Manager </p>
                                        <p>Wanda Jones
                                            212-632-9482 <span>Wjones@Beveragedynamics.com </span>
                                        </p>
                                    </div>
                                </div>
                            </div>
