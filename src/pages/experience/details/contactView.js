          ...
          <div className="flex xl:gap-8 flex-wrap md:flex-nowrap">
            <div className="contactListView">
              ...
              <div className="notes">
                <h5>Notes</h5>
                <p>
                  Willing to take all placements and wants to do a Promo event
                  every week for the 3rd quarter
                </p>
              </div>
            </div>
            <div className="contactListView">
              ...
              <div className="notes">
                <h5>Notes</h5>
                <p>Loves Gin and Tonic drinks. Wants more gin cocktail ideas</p>
              </div>
            </div>
            <div className="contactListView">
              <h4>Mogadi Singh- Brooklyn, NYC, Bronx Rep</h4>
              ...
              <div className="notes">
                <h5>Notes</h5>
                <p>
                  Very particular about bills being paid on time. Needs weekly
                  invoice statements sent to her
                </p>
              </div>
            </div>
          </div>
