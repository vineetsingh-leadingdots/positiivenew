  ...
  return (
    <>
      <div className="displayProduct">
        ...
        <div className="itemContent">
          ...
          <div className="shareSec">
            ...
            <button onClick={handleClick}>
              <DotsIcon />
              <div className={deleteShow ? "deletePopup show" : "deletePopup"}>
                Delete
              </div>
            </button>
          </div>
        ...
        <div className="w-full">
          <div className="tasteSec ">
            <div className="div pr-14">
              <label>{taste}</label>
              <div className="flex">
                <img src={tasteImgOne} className="mr-4" />
                <img src={tasteImgTwo} />
              </div>
            </div>
            <div className="div pr-14">
              <label>{Nose}</label>
              <div className="flex">
                <img src={noseImg} className="mr-4" />
                <img src={noseImg2} className="mr-4" />
              </div>
            </div>
          </div>
        ...
        <div
          className={
            expandShow ? "expandConent active w-full" : "expandConent w-full"
          }
        >
          <label>Description</label>
          <p>
            At night on ponce IPA. Three Taverns 3 Craft beers. What you are
            about to drink. A night on ponce IPA grafts on American ale yeast on
            to the same malts and hops used in a night in brussels IPA. The
