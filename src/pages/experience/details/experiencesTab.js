            ...
            <div className="ligthGary">
              <div className="mostRecentArea">
                ...
                <div className=" ml-auto">
                  <button className="btn-save flex items-center gap-3 btnSm md:w-auto w-full ">
                    <svg
              ...
              <div className="w-full newProductHeading  ">
                <div className="mb-4 md:mb-0">
                  <h2>New Pernod Products</h2>
                  <p className="label2 pt-1">July 21, 2022</p>
                </div>
                <div>
                  <div className="flex newProductBtns ">
                    <button className="flex gap-1 textBlue items-center">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="17"
                  ...
                  <div className="text-right pt-4">
                    <p className="text-[12px] textBlue opacity-70">
                      Sent to 3 customers
                    </p>
                  </div>
                </div>
