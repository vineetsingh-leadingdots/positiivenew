...
import { RatingColumns, RatingData } from '../../../commonComponents/tableData'
    ...
    const RatingData = ratingListData?.data.map((rating) => ({
        ...
        Actions: (
            <div className="flex gap-1">
               <button onClick={() => navigate("/rating/add", { state: { ratingData: rating } })} className="actionButton">
                    <i className="fa fa-pencil" />
                </button>
                <DeletePopup
                    ratingdeleteId={rating?.id}
