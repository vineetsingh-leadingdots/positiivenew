                                    ...
                                    <div className="flex 	flex-wrap justify-center">
                                        ...
                                        <div className='imageButtonRadius'>
                                            <button type="button"
                                                ...
                                                className='btn_circle'><i className="fa fa-file-image" /></button>
                                            <button type="button"
                                                onClick={() => setImageView('image_rectangle')}
                                                className='btn_rectangle'><i className="fa fa-file-image" /></button>
                                            <button type="button"
                                                onClick={() => setImageView('image_square')}
                                                className='btn_square'><i className="fa fa-file-image" /></button>
                                        </div>
