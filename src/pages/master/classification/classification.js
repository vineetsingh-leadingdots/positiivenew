...
import { BrandColumns, BrandData, ClassificationColumns, ClassificationData } from '../../../commonComponents/tableData'
            ...
            <div className='content'>
                ...
                <div className='card '>
                    <div className='tableAreaMaster '>
                        <TableList data={ClassificationData} columns={ClassificationColumns} />
                    </div>
                </div>
            </div>
        </>
