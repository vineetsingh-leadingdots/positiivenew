        ...
        <>
            <div className='content masterPages'>
                <div className='w-full mb-4'>
                    <h2 className='mb-4'> Distributor Add</h2>
                </div>
                        ...
                        <form id="brandAdd">
                            <div className='w-full'>
                                ...
                                <Col xs={24} md={12}>
                                    <div className=" w-full ">
                                        <div className="form-group mb-6 ">
                                            <label className="formBlock mb-2 py-2">Organization Name *</label>
                                            <input
                                                id="name"
                                                name="name"
                                                type="text"
                                ...
                                <Col xs={24} md={12}>
                                    <div className=" w-full ">
                                        <div className="form-group mb-6 ">
                                            <label className="formBlock mb-2 py-2">Registration No. *</label>
                                            <input
                                                id="name"
                                                name="name"
                                                type="text"
                            ...
                            <Row gutter={[16, 0]}>
                                <Col xs={24} md={12}>
                                    <div className=" w-full ">
                                        <div className="form-group mb-6 ">
                                            <label className="formBlock mb-2 py-2">Subscription Package</label>
                                            <select className="formControl" >
                            ...
                            <div className="w-full formFooter">
                                <div className=" form-group pt-8 pb-3 flex  gap-3 ">
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => navigate("/distributor/list")}
