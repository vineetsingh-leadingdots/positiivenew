                    ...
                    <div className='flex justify-between items-center mb-4 flex-wrap md:flex-nowrap'>
                        ...
                        <div className='flex gap-1 flex-wrap md:flex-nowrap'>
                            ...
                            <Link
                                ...
                                <span className="fa fa-glass-cheers" />Products
                            </Link>
                            <Link
                                title={'edit'}
                               to={'/supplier/add'}
