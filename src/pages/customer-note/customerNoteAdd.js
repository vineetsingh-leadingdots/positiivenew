...
const CustomerNoteAdd = () => {
    ...
    return (
        <>
         <HelmetProvider>
                <Helmet>
                    <title>Positiive | Customer-Note-Add </title>
                </Helmet>
            </HelmetProvider>
            <div className='content masterPages'>
                <div className='w-full mb-4'>
                    <h2 className='mb-4'> Add Customer Note</h2>
                </div>
                            ...
                            <Col xs={24} >
                                    <div className=" w-full ">
                                        <div className="form-group mb-6 ">
                                            <label className="formBlock mb-2 py-2">Customer Note</label>
                                            <textarea
                                                id="name"
                                                name="name"
                                                type="text"
...
export default CustomerNoteAdd